...
public final class ServerMelodyManager {
    private static final String INDEX_DATA_NAME = "immersive_melodies_index";
    private static final String TRACK_DATA_NAME = "immersive_melodies_tracks";
    private static final String SAVE_ROOT = "immersive_melodies";
    ...
    public static Melody getMelody(World world, ResourceLocation id) {
        ...
        if (id.getNamespace().equals("immersive_melodies")) {
            String path = "data/immersive_melodies/" + id.getPath();
            try (InputStream in = ServerMelodyManager.class.getClassLoader().getResourceAsStream(path)) {
                if (in != null) {
                    Melody parsed = immersive_melodies.util.MidiParser.parseMidi(in, id.getPath());
    ...
    public static ResourceLocation getRandomMelody(World world) {
        ...
        if (index.melodies.isEmpty()) {
            return new ResourceLocation("immersive_melodies", "melodies/wet_hands.midi");
        }
    ...
    private static void ensureBuiltinsLoaded(World world) {
        ...
        for (String name : names) {
            ResourceLocation id = new ResourceLocation("immersive_melodies", "melodies/" + name);
