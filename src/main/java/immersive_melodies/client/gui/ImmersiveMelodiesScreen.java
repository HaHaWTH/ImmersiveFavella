...
import immersive_melodies.network.c2s.MelodyDeleteMessage;
...
public class ImmersiveMelodiesScreen extends GuiScreen {
    private static final ResourceLocation BACKGROUND = new ResourceLocation("immersive_melodies", "textures/gui/paper.png");
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiButton(1, centerX - 75, centerY + 78, 36, 20, I18n.format("immersive_melodies.play")));
        buttonList.add(new GuiButton(2, centerX - 37, centerY + 78, 36, 20, I18n.format("immersive_melodies.pause")));
        buttonList.add(new GuiButton(3, centerX + 1, centerY + 78, 36, 20, I18n.format("immersive_melodies.delete")));
        buttonList.add(new GuiButton(0, centerX + 39, centerY + 78, 36, 20, I18n.format("immersive_melodies.close")));
        refreshPage();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(fontRenderer, I18n.format("itemGroup.immersive_melodies_tab"), width / 2, height / 2 - 90, 0xFFFFFF);
        drawCenteredString(fontRenderer, I18n.format("immersive_melodies.keyboard"), width / 2, height / 2 - 70, 0xAAAAAA);
        drawString(fontRenderer, I18n.format("immersive_melodies.search") + ": " + query, width / 2 - 90, height / 2 - 62, 0xCCCCCC);
    ...
    public void handleKeyboardInput() throws IOException {
        ...
        if (Keyboard.getEventKeyState()) {
            immersive_melodies.MidiListener.keyPressed(keyCode);
        } else {
            immersive_melodies.MidiListener.keyReleased(keyCode);
        }
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    immersive_melodies.Common.LOGGER.error("Failed to open file dialog", e);
                    Minecraft.getMinecraft().addScheduledTask(new Runnable() {
                        @Override
                        public void run() {
    ...
    private void uploadFromFile(File file) {
        try {
            ...
            immersive_melodies.Common.LOGGER.error("Upload failed", e);
    ...
    private void openDropUploadWindow() {
        try {
            ...
            new DropTarget(dropFrame, new DropTargetAdapter() {
                ...
                public void drop(DropTargetDropEvent dtde) {
                    try {
                        ...
                        immersive_melodies.Common.LOGGER.error("Drop upload failed", e);
            ...
            immersive_melodies.Common.LOGGER.error("Failed to open drop window", e);
