package immersive_melodies.event;
...
@Mod.EventBusSubscriber(modid = immersive_melodies.Common.MOD_ID)
public class MobInstrumentEvents {
    ...
    public static void onLivingTick(LivingEvent.LivingUpdateEvent event) {
        ...
        if (stack.getItem() instanceof InstrumentItem) {
            ...
            if (!stack.hasTagCompound() || stack.getSubCompound(immersive_melodies.Common.MOD_ID) == null || !stack.getSubCompound(immersive_melodies.Common.MOD_ID).getBoolean(InstrumentItem.TAG_PLAYING)) {
